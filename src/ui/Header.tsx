        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-3">
            {showBackButton && (
              <button
                onClick={onBack}
                className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-[#121212] transition-colors rtl:ml-1 rtl:sm:ml-2 ltr:mr-1 ltr:sm:mr-2 border border-transparent hover:border-[#FF4D00]/50"
              >
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gray-50 dark:bg-[#121212] flex items-center justify-center border border-gray-200 dark:border-[#1E1E1E] shadow-sm dark:shadow-[0_0_20px_rgba(255,77,0,0.1)]">
                <Languages className="w-4 h-4 sm:w-5 sm:h-5 text-[#FF4D00]" />
              </div>
              <div className="text-start">
                <h1 className="text-lg sm:text-xl font-extrabold text-gray-900 dark:text-white tracking-tighter">
                  TalkBridge
                </h1>
                <p className="hidden sm:block text-[10px] text-[#FF4D00] -mt-1 font-bold uppercase tracking-[0.2em]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="p-2.5 sm:p-3 rounded-full hover:bg-gray-100 dark:hover:bg-[#121212] transition-colors border border-transparent hover:border-[#FF4D00]/50"
            ...
            <div ref={dropdownRef} className="relative">
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-2 sm:py-2.5 rounded-xl bg-orange-50 dark:bg-[#121212] border border-orange-100 dark:border-[#1E1E1E] hover:border-[#FF4D00]/50 transition-all group"
                title={t.langToggleTooltip}
                aria-label={t.langToggleTooltip}
              >
                <Languages className="w-4 h-4 sm:w-5 sm:h-5 text-[#FF4D00] shrink-0" />
                    ...
                    return (
                      <>
                        ...
                        >
                          ...
                          {isSelected && <Check className="w-4 h-4 shrink-0 text-[#FF4D00]" />}
                        </button>
                      </>
                    );
                  })}
