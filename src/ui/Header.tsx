...
export default function Header({ showBackButton = false, onBack }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/85 dark:bg-[#080808]/85 backdrop-blur-xl border-b border-gray-200 dark:border-[#1E1E1E]">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 flex-row-reverse">
          {/* Logo (Right side visually because of flex-row-reverse) */}
          <div className="flex items-center gap-3 flex-row-reverse">
            {showBackButton && (
              <button
                onClick={onBack}
                className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-[#121212] transition-colors ml-1 sm:ml-2 border border-transparent hover:border-[#FF4D00]/50"
              >
          ...
          <div className="flex items-center gap-2 flex-row-reverse">
            ...
            <div
              className="p-2.5 sm:p-3 rounded-full bg-orange-50 dark:bg-[#121212] border border-orange-100 dark:border-[#1E1E1E]"
              title="لغات متعددة"
              aria-label="لغات متعددة"
            >
