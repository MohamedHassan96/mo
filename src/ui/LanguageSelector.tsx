      ...
      <div className="relative">
        ...
        <select
          ...
          className="w-full pl-11 pr-5 py-3 rounded-[20px] border border-gray-200 dark:border-[#1E1E1E] 
                     bg-gray-50 dark:bg-[#010816] text-gray-950 dark:text-white
                     focus:outline-none focus:ring-1 focus:ring-[#006494] focus:border-[#006494]
        ...
        >
          {SUPPORTED_LANGUAGES.map((lang) => (
            <option key={lang.code} value={lang.code} className="bg-white dark:bg-[#112240] text-gray-950 dark:text-white font-bold py-2">
