      ...
      <div className="relative">
        ...
        <select
          ...
          className="w-full pl-11 pr-5 py-3 rounded-[20px] border border-gray-200 dark:border-[#1E1E1E] 
                     bg-gray-50 dark:bg-[#022C22] text-gray-950 dark:text-white
                     focus:outline-none focus:ring-1 focus:ring-#A3E635 focus:border-[#A3E635]
        ...
        >
          {SUPPORTED_LANGUAGES.map((lang) => (
            <option key={lang.code} value={lang.code} className="bg-white dark:bg-[#065F46] text-gray-950 dark:text-white font-bold py-2">
