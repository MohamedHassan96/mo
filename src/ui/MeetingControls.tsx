    ...
    <div className="bg-white/90 dark:bg-[#121212]/90 backdrop-blur-xl border-t border-gray-200 dark:border-[#1E1E1E] px-3 sm:px-6 py-3 sm:py-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:pb-4">
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 min-w-0">
          ...
          <button
            onClick={onToggleMic}
            className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-all border border-gray-200 dark:border-[#1E1E1E] hover:border-[#FF4D00]/50 ${
              isMicOn
          ...
          <button
            ...
            className={`hidden sm:flex w-14 h-14 rounded-full items-center justify-center transition-all border border-gray-200 dark:border-[#1E1E1E] hover:border-[#FF4D00]/50 ${
              isScreenSharing
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className={`hidden sm:flex w-12 h-12 rounded-full items-center justify-center transition-all border border-gray-200 dark:border-[#1E1E1E] hover:border-[#FF4D00]/50 ${
              audioPlaybackEnabled
