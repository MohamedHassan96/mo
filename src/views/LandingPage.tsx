...
export default function LandingPage({ onCreateRoom, onJoinRoom }: LandingPageProps) {
  ...
  const features = [
    ...
    { icon: Mic,           title: t.feat2Title, description: t.feat2Desc, color: 'from-sky-600 to-sky-500' },
    { icon: MonitorUp,     title: t.feat3Title, description: t.feat3Desc, color: 'from-green-500 to-emerald-500' },
    { icon: MessageSquare, title: t.feat4Title, description: t.feat4Desc, color: 'from-sky-600 to-[#004a70]lue-600' },
    { icon: Globe,         title: t.feat5Title, description: t.feat5Desc, color: 'from-blue-600 to-cyan-600' },
    { icon: Zap,           title: t.feat6Title, description: t.feat6Desc, color: 'from-sky-400 to-sky-600' },
  ];

  return (
    <div className="min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-5rem)] flex flex-col bg-gray-50 dark:bg-[#010816] selection:bg-[#006494] selection:text-white" dir={isRtl ? 'rtl' : 'ltr'}>
      {/* Hero */}
      <section className="relative overflow-hidden pt-10 sm:pt-20 pb-16 sm:pb-32">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#002e47] opacity-[0.15] rounded-full blur-[120px]" />
        </div>

        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center flex flex-col items-center">
            {/* Tag */}
            <div className="animate-fade-up inline-flex items-center gap-2 px-4 sm:px-5 py-2 rounded-full bg-[#002e47]lue-50 dark:bg-[#00040d] border border-blue-200 dark:border-[#006494]/20 mb-6 sm:mb-8">
            ...
            <h1 className="animate-fade-up delay-100 text-[42px] sm:text-[72px] lg:text-[96px] font-extrabold text-gray-900 dark:text-white tracking-tighter leading-[1.02] sm:leading-[0.95] max-w-4xl mx-auto">
              {t.heroTitle}
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-[#004a70] from-[#006494] to-[#004a70]">
                {t.heroHighlight}
              </span>
            </h1>
            ...
            <div className="animate-fade-up delay-300 mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm font-bold text-gray-600 dark:text-[#737373]">
              <span className="flex items-center gap-2 bg-white dark:bg-[#112240] px-3 sm:px-4 py-2 rounded-full border border-gray-200 dark:border-[#1E1E1E] shadow-sm dark:shadow-none">
            ...
            <div className="animate-fade-up delay-400 mt-10 sm:mt-14 flex flex-col md:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-2xl mx-auto">
              ...
              <button
                ...
                className="group flex-1 w-full md:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-4 sm:py-5 bg-[#006494] text-white rounded-2xl text-base sm:text-lg font-bold 
                           shadow-[0_0_30px_rgba(0,100,148,0.3)] hover:shadow-[0_0_50px_rgba(0,100,148,0.5)]
              ...
              <form onSubmit={handleJoinRoom} className="flex-1 w-full md:w-auto flex items-center gap-2 relative">
                <input
                  ...
                  dir={isRtl ? 'rtl' : 'ltr'}
                  className="w-full px-5 sm:px-6 py-4 sm:py-5 bg-white dark:bg-[#112240] border border-gray-200 dark:border-gray-800 rounded-2xl text-base sm:text-lg font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-[#006494] focus:ring-1 focus:ring-[#006494] transition-all shadow-sm"
                />
                <button
                  type="submit"
              ...
              {[
                ...
                <div key={item.step} className="flex items-center">
                  <div className="flex flex-col items-center w-full">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-[18px] sm:rounded-[20px] bg-white dark:bg-[#112240] border border-gray-200 dark:border-[#1E1E1E] flex items-center justify-center mb-3 sm:mb-4 group-hover:border-[#006494]/50 transition-colors shadow-sm dark:shadow-none">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-16 sm:pb-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" dir={isRtl ? 'rtl' : 'ltr'}>
          {features.map((feature, i) => (
            <div
              key={feature.title}
              className={`animate-fade-up group p-5 sm:p-8 rounded-[24px] sm:rounded-[35px] bg-white dark:bg-[#112240] border border-gray-200 dark:border-[#1E1E1E]
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-gray-200 dark:border-[#1E1E1E] py-10 sm:py-16 bg-gray-50 dark:bg-[#010816] relative overflow-hidden">
        {/* Glow behind footer */}
