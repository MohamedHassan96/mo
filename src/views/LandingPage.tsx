...
export default function LandingPage({ onCreateRoom, onJoinRoom }: LandingPageProps) {
  ...
  const features = [
    { icon: Video,         title: t.feat1Title, description: t.feat1Desc, color: 'from-lime-600 to-cyan-500' },
    { icon: Mic,           title: t.feat2Title, description: t.feat2Desc, color: 'from-lime-600 to-lime-500' },
    { icon: MonitorUp,     title: t.feat3Title, description: t.feat3Desc, color: 'from-green-500 to-green-500' },
    { icon: MessageSquare, title: t.feat4Title, description: t.feat4Desc, color: 'from-lime-600 to-[#4D7C0F]' },
    { icon: Globe,         title: t.feat5Title, description: t.feat5Desc, color: 'from-[#65A30D] to-cyan-600' },
    { icon: Zap,           title: t.feat6Title, description: t.feat6Desc, color: 'from-lime-400 to-lime-600' },
  ];

  return (
    <div className="min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-5rem)] flex flex-col bg-gray-50 dark:bg-[#022C22] selection:bg-[#A3E635] selection:text-white" dir={isRtl ? 'rtl' : 'ltr'}>
      {/* Hero */}
      <section className="relative overflow-hidden pt-10 sm:pt-20 pb-16 sm:pb-32">
        {/* Abstract Liquid Background */}
        <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#A3E635] opacity-[0.15] rounded-full blur-[120px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#064E3B] opacity-[0.15] rounded-full blur-[120px]" />
        </div>

        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center flex flex-col items-center">
            {/* Tag */}
            <div className="animate-fade-up inline-flex items-center gap-2 px-4 sm:px-5 py-2 rounded-full bg-lime-50 dark:bg-[#00040d] border border-emerald-200 dark:border-[#A3E635]/20 mb-6 sm:mb-8">
              <span className="text-xs font-bold text-[#65A30D] tracking-[0.2em] uppercase">
                {t.tagline}
              </span>
            </div>
            ...
            <h1 className="animate-fade-up delay-100 text-[42px] sm:text-[72px] lg:text-[96px] font-extrabold text-gray-900 dark:text-white tracking-tighter leading-[1.02] sm:leading-[0.95] max-w-4xl mx-auto">
              {t.heroTitle}
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#A3E635] to-[#65A30D]">
                {t.heroHighlight}
              </span>
            </h1>
            ...
            <div className="animate-fade-up delay-300 mt-8 sm:mt-10 flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm font-bold text-gray-600 dark:text-[#737373]">
              <span className="flex items-center gap-2 bg-white dark:bg-[#065F46] px-3 sm:px-4 py-2 rounded-full border border-gray-200 dark:border-[#1E1E1E] shadow-sm dark:shadow-none">
                <Video className="w-4 h-4 text-[#65A30D]" /> {t.badgeHD}
              </span>
              <span className="flex items-center gap-2 bg-white dark:bg-[#065F46] px-3 sm:px-4 py-2 rounded-full border border-gray-200 dark:border-[#1E1E1E] shadow-sm dark:shadow-none">
                <Users className="w-4 h-4 text-[#65A30D]" /> {t.badgeLink}
              </span>
              <span className="flex items-center gap-2 bg-white dark:bg-[#065F46] px-3 sm:px-4 py-2 rounded-full border border-gray-200 dark:border-[#1E1E1E] shadow-sm dark:shadow-none">
                <Languages className="w-4 h-4 text-[#65A30D]" /> {t.badgeTranslate}
              </span>
            </div>
            ...
            <div className="animate-fade-up delay-400 mt-10 sm:mt-14 flex flex-col md:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-2xl mx-auto">
              ...
              <button
                ...
                className="group flex-1 w-full md:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-4 sm:py-5 bg-[#A3E635] text-white rounded-2xl text-base sm:text-lg font-bold 
              ...
              <form onSubmit={handleJoinRoom} className="flex-1 w-full md:w-auto flex items-center gap-2 relative">
                <input
                  ...
                  dir={isRtl ? 'rtl' : 'ltr'}
                  className="w-full px-5 sm:px-6 py-4 sm:py-5 bg-white dark:bg-[#065F46] border border-gray-200 dark:border-gray-800 rounded-2xl text-base sm:text-lg font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-[#A3E635] focus:ring-1 focus:ring-#A3E635 transition-all shadow-sm"
                />
                <button
                  type="submit"
                  disabled={!roomCode.trim()}
                  className="absolute ltr:right-2 rtl:left-2 top-2 bottom-2 aspect-square flex items-center justify-center bg-gray-100 dark:bg-[#1A1A1A] hover:bg-[#A3E635] text-gray-600 dark:text-gray-400 hover:text-white rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed group/join"
                >
              ...
              {[
                ...
                <div key={item.step} className="flex items-center">
                  <div className="flex flex-col items-center w-full">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-[18px] sm:rounded-[20px] bg-white dark:bg-[#065F46] border border-gray-200 dark:border-[#1E1E1E] flex items-center justify-center mb-3 sm:mb-4 group-hover:border-[#A3E635]/50 transition-colors shadow-sm dark:shadow-none">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-16 sm:pb-32">
        <div className="mb-8 sm:mb-12 text-center">
          <span className="text-[#65A30D] font-bold tracking-[0.2em] uppercase text-xs">
            {t.featuresLabel}
          </span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" dir={isRtl ? 'rtl' : 'ltr'}>
          {features.map((feature, i) => (
            <div
              key={feature.title}
              className={`animate-fade-up group p-5 sm:p-8 rounded-[24px] sm:rounded-[35px] bg-white dark:bg-[#065F46] border border-gray-200 dark:border-[#1E1E1E]
            ...
            >
              <div
                className={`w-14 h-14 rounded-full bg-gray-50 dark:bg-[#1A1A1A] flex items-center justify-center mb-6 
                            group-hover:bg-[#A3E635]/10 transition-colors duration-300`}
              >
                <feature.icon className="w-6 h-6 text-[#65A30D]" />
              </div>
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-gray-200 dark:border-[#1E1E1E] py-10 sm:py-16 bg-gray-50 dark:bg-[#022C22] relative overflow-hidden">
        {/* Glow behind footer */}
        <div className="absolute bottom-[-50%] left-1/2 -translate-x-1/2 w-[80%] h-[100%] bg-[#A3E635] opacity-[0.05] blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center gap-5 sm:gap-6 relative z-10 text-center">
          <div className="flex items-center gap-3">
            <Video className="w-6 h-6 text-[#65A30D]" />
